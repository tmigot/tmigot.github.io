...
tags:
  ...
  - Stopping
---
The new version of Stopping.jl is now official on Julia. 
It is the first stable version of it, and I will now soon release more codes using it for MPCC and GNEP.
Currently, the main page of the project is here:
[Stopping.jl](https://github.com/Goysa2/Stopping.jl)

## Stopping.jl: Motivation
